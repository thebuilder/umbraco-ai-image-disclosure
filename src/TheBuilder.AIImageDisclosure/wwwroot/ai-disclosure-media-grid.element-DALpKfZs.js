...
import { MediaService as F } from "@umbraco-cms/backoffice/external/backend-api";
...
var i1 = Object.defineProperty, a1 = Object.getOwnPropertyDescriptor, x = (e) => {
  throw TypeError(e);
}, g = (e, s, t, i) => {
  for (var l = i > 1 ? void 0 : i ? a1(s, t) : s, C = e.length - 1, T; C >= 0; C--)
    (T = e[C]) && (l = (i ? T(s, t, l) : T(l)) || l);
  return i && l && i1(s, t, l), l;
}, E = (e, s, t) => s.has(e) || x("Cannot " + t), c = (e, s, t) => (E(e, s, "read from private field"), s.get(e)), o = (e, s, t) => s.has(e) ? x("Cannot add the same private member more than once") : s instanceof WeakSet ? s.add(e) : s.set(e, t), b = (e, s, t, i) => (E(e, s, "write to private field"), s.set(e, t), t), r = (e, s, t) => (E(e, s, "access private method"), t), l1 = (e, s, t, i) => ({
  set _(l) {
    b(e, s, l);
  },
  get _() {
...
S = async function(e) {
  ...
  c(this, m).add(e);
  try {
    const { data: s, error: t } = await G(
      this,
      F.getMediaById({ path: { id: e } }),
...
H = function(e) {
  ...
  if (s === I)
    return { accessibleLabel: I, url: e1 };
  if (s === O)
    return { accessibleLabel: O, url: s1 };
};
R = function(e) {
...
u.styles = [
  ...
  K`
      ...
      .disclosure-badge {
        position: absolute;
        inset: var(--uui-size-space-3) auto auto var(--uui-size-space-3);
...
//# sourceMappingURL=ai-disclosure-media-grid.element-DALpKfZs.js.map
